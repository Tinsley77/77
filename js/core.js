...
const loadData = async () => {
    try {
        ...
        try { if (typeof loadWordBank === 'function') await loadWordBank(); } catch(e) { console.warn("造词库加载失败", e); }
        if (typeof _scheduleWordBankAuto === 'function') _scheduleWordBankAuto();
...
const LIBRARY_CONFIG = {
    reply: {
        ...
        tabs: [
            ...
            { id: 'wordbank', name: '造词库', mode: 'list' },
            ...
            for (let i = 0; i < replyCount; i++) {
                ...
                setTimeout(() => {
                    ...
                    if (picked && String(picked).trim()) {
                        ...
                        replyText = String(picked).trim() + punctuation;
                    }
